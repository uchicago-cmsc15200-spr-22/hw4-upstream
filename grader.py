...
RUBRIC = [
          ("Exercise 1: Valid card", "valid_card", 8.0),
          ("Exercise 2: Cut", "cut", 8.0),  
          ("Exercise 3: Flush", "flush", 12.0),
          ("Exercise 4: Four of a kind", "four_of_a_kind", 12.0), 
          ("Exercise 5: Bust", "bust", 8.0),  
          ("Exercise 6: Winner", "winner", 12.0)
         ]
